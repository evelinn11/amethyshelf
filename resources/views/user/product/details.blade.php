            ...
            <div class="product-carousel-container">
                <div class="product-carousel-inner">
                    ...
                    @if ($product->images->count() > 1)
                        <button class="scroll-btn left" onclick="scrollCarousel('carousel-product-images', -1)"
                            ...
                            <div class="carousel-1" id="carousel-product-images">
                                ...
                                @forelse ($product->images as $image)
                                    <div class="product-image-card">
                                        <img src="{{ asset($image->product_images_url) }}" alt="Product Image"
                        ...
                        <button class="scroll-btn right" onclick="scrollCarousel('carousel-product-images', 1)"
