    ...
    <head>
        ...
        <style>
            ...
            @media (max-width: 768px) {
                ...
                table {
                    min-width: 600px; /* or whatever your min width needs */
                }
            }
        </style>
        ...
        <div class="category-container">
            ...
            <div class="summary-container">
                <div class="summary-box">
                    <p class="summary-label">Total Active Orders</p>
                    <p class="summary-value">100</p>
                </div>
                <div class="summary-box">
                    <p class="summary-label">Waiting Delivery</p>
                    <p class="summary-value">100</p>
                </div>
                <div class="summary-box">
                    <p class="summary-label">Shipped</p>
                    <p class="summary-value">100</p>
                </div>
                <div class="summary-box">
                            ...
                            <tr class="border-t">
                                ...
                                <td class="px-4 py-2">
                                    <span
                                        ...
                                        @elseif($order['status'] == 'In delivery') text-blue-500 
                                        @elseif($order['status'] == 'Cancelled') text-red-500 
                                        @elseif($order['status'] == 'Processing') text-orange-500 @endif">
                                        {{ $order['status'] }}
                                    </span>
                                </td>
                                <td class="px-4 py-2 text-indigo-600 hover:underline">
                                    <a href="{{ route('admin-order-details') }}">See Order Details</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
