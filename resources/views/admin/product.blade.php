            ...
            <div>
                <form action="{{ route('product') }}" method="GET" class="search-bar">
                    <input type="text" name="search" value="{{ request('search') }}"
                        placeholder="Search by ID, title or author then hit 'Enter'">
                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr>
                            <td>{{ $product->id }}</td>
                            <td>
                                <div class="truncate-text" title="{{ $product->products_title }}">
                                    {{ $product->products_title }}</div>
                            </td>
                            <td>
                                <div class="truncate-text" title="{{ $product->products_author_name }}">
                                    {{ $product->products_author_name }}</div>
                            </td>
