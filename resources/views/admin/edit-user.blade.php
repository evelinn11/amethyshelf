...
<head>
    <meta charset="UTF-8">
    <title>Edit User - Amethyshelf Admin</title>
    <style>
        * {
...
<div class="user-container">
    ...
    <form id="editUserForm" action="{{ route('edit-user-post', $user->id) }}" method="POST" class="add-user-form">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="tel" name="phone_number" id="phone_number" value="{{ old('phone_number', $user->phone_number) }}" required pattern="[0-9]*" inputmode="numeric">
        </div>
        ...
        <div class="form-group">
            ...
            <select name="role" id="role" required>
                ...
                <option value="U" {{ old('role', $user->role) == 'U' ? 'selected' : '' }}>Customer</option>
            </select>
        </div>
